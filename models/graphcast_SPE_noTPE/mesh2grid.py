...
class Mesh2GridGNN(nn.Module):
    ...
    def forward(self, data):
        edge_new = self.edge_mlp(torch.cat((data['mesh','to','grid'].edge_attr,data['mesh'].x[data['mesh','to','grid'].edge_index[0]],data['grid'].x[data['mesh','to','grid'].edge_index[1]]), dim=-1))
