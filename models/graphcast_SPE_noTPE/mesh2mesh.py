...
class Mesh2MeshGNN(nn.Module):
    ...
    def forward(self, data):
        edge_new = self.edge_mlp(torch.cat((data['mesh','to','mesh'].edge_attr,data['mesh'].x[data['mesh','to','mesh'].edge_index[0]],data['mesh'].x[data['mesh','to','mesh'].edge_index[1]]), dim=-1))
        ...
        data['mesh', 'to', 'mesh'].edge_attr = data['mesh', 'to', 'mesh'].edge_attr + edge_new
        return data