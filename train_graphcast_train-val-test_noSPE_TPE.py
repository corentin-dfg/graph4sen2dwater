...
from data.sits_to_graph_noSPE_TPE import SitsToGraph
from data import SitsDataset, DeterminedSubSitsFromEnd
from models.graphcast_noSPE_TPE import GraphCast
...
writer = SummaryWriter(comment=f"_{model._get_name()}_SEED-{SEED}_SPLX-{NB_SPXL}_COMPACTNESS-{COMPACTNESS}_TLEN-{T_LEN}_noSPE-TPE")
